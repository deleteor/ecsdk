...
import (
	...
	"git.hp6h2.cn/gobin/commons/gtype/money"
)
...
type BonusOrderResq struct {
	...
	PayPrice money.Money `json:"payPrice"`
	// EstimateCosPrice 	是	1.00	预估计佣金额
	EstimateCosPrice money.Money `json:"estimateCosPrice"`
	// EstimateFee 	是	0.04	预估佣金
	EstimateFee money.Money `json:"estimateFee"`
	// ActualCosPrice 	是	0.00	实际计佣金额
	ActualCosPrice money.Money `json:"actualCosPrice"`
	// ActualFee 	是	0.00	实际佣金
	ActualFee money.Money `json:"actualFee"`
	...
	EstimateBonusFee money.Money `json:"estimateBonusFee"`
	// ActualBonusFee 	是	0	实际奖励金额
	ActualBonusFee money.Money `json:"actualBonusFee"`
