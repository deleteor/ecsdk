...
func (d *DDK) GoodsDetail(goodsId int) (res *Goods, err error) {
	res = new(Goods)
	params := NewParamsWithType(DDKGoodsDetail)
...
// GoodsPromotionURLGenerate create promotion url
func (d *DDK) GoodsPromotionURLGenerate(pid string, goodsID int, notMustparams ...Params) (res *GoodsPromotionURL, err error) {
	params := NewParamsWithType(DDKGoodsPromotionURLGenerate, notMustparams...)
	params.Set("p_id", pid)
	params.Set("goods_id_list", fmt.Sprintf("[%d]", goodsID))
...
func (d *DDK) TopGoodsListQuery(notMustparams ...Params) (res *TopGoodsListResponse, err error) {
	...
	params := NewParamsWithType(DDKTopGoodsListQuery, notMustparams...)
...
func (d *DDK) GoodsZsURLGen(sourceURL, pid string) (res *GoodsZsURL, err error) {
	res = new(GoodsZsURL)
	params := NewParamsWithType(DDKGoodsZsUnitURLGen)
